...
よく言われるのは「コンピュータは所詮 0 と 1 しかない」「プログラムは順序・分岐・繰り返ししかない」っていう人が多いのではないでしょうか？
...
この方式を採用することで、引数の部分適用など、便利になる場面もあります。
...
console.log(ITO_BOOLEAN(TRUE)) // true
